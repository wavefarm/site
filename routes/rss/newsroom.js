...
module.exports = function (req, res) {
	...
	var basePath = 		req.connection.encrypted?'https://':'http://' + req.headers.host;
		
	var sitePath = '';	
	var feedTitle = 'Wave Farm Newsroom RSS';
	...
	if (site=='wgxc') {
		...
		feedTitle = 'Waver Farm Newsroom RSS';
	...
	var params = qs.parse('q=type:news'+sites+'&sort=-date&size=50')	
